...
public class QuestUtils {
	...
	public static void init() {
		...
		while (i < qu) {
			questList[i][0] = "n";
			questList[i][1] = Utils.getKey(Resources.resdoc, "quest", i + "", "starttext");
			questList[i][2] = Utils.getKey(Resources.resdoc, "quest", i + "", "completedtext");
			questList[i][3] = Utils.getKey(Resources.resdoc, "quest", i + "", "afterstarttext");
			questList[i][4] = Utils.getKey(Resources.resdoc, "quest", i + "", "requirement");
			questList[i][6] = Utils.getKey(Resources.resdoc, "quest", i + "", "repeatable");
			questList[i][9] = Utils.getKey(Resources.resdoc, "quest", i + "", "forquest");
			i++;
		}
	}
