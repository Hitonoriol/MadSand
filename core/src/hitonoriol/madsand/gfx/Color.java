...
public class Color implements Serializable {
	 ...
	 * in the range [0,1]. The result is stored in
	 * this color.
	 * 
	 ...
	 * then converts it to a float. Alpha is compressed
	 * from 0-255 to use only even numbers between 0-254 to avoid using float bits
	 * in the NaN range (see
	 * {@link NumberUtils#intToFloatColor(int)}). Converting a color to a float and
	 * back can be lossy for alpha.
	 * 
	...
	/**
	 * Packs the color components into a 32-bit integer with the format ABGR and
	 * then converts it to a float. Note that no range
	 ...
	 * that no range checking is performed for higher
	 * performance.
	 * 
	 * @param r the red component, 0 - 255
	 * @param g the green component, 0 - 255
	...
	/**
	 * Sets the Color components using the specified integer value in the format
	 * RGBA4444. This is inverse to the rgba4444(r, g,
	 * b, a) method.
	 * 
	 * @param color The Color to be modified.
	...
	/**
	 * Sets the Color components using the specified integer value in the format
	 * RGBA8888. This is inverse to the rgba8888(r, g,
	 * b, a) method.
	 * 
	 * @param color The Color to be modified.
	...
	/**
	 * Sets the Color components using the specified integer value in the format
	 * ARGB8888. This is the inverse to the argb8888(a,
	 * r, g, b) method
	 *
	 * @param color The Color to be modified.
	 ...
	 * that HSV components are voluntary not clamped
	 ...
	 * {@link #fromHsv(float, float, float)}. This is the inverse of
	 * {@link #toHsv(float[])}.
	 * 
